...
The file `UScountiesC19Data.r` reformats the [USA Facts](https://usafacts.org/visualizations/coronavirus-covid-19-spread-map/) COVID datasets. 
...
* Some of the cumulative totals were non-monotonic. I have monotonized them. 
...
* I suspect the `case` data are more a reflection of the number of tests being done than the number of people in the population who have the disease. The number of cases is a nondecreasing function of the number of tests, and reasons for and rates of testing may vary greatly by county. If someone has some data on the number of positive tests among a random sample from any population, please let me know. 
...
If you haven't created or downloaded this file locally, you can load it into your R session directly from the web as follows:
...
```
Note that we've just removed any data that were not 
allocated to a specific county. This includes some data from NYC, and some data from the Grand Princess Cruise Ship that was allocated to CA but not to a county. 
